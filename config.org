    ...
    #+BEGIN_SRC emacs-lisp
      (use-package go-mode
        ...
        (if (executable-find "goimports")
          ...
          (display-warning '(user-configuration) "Unable to find `goimports' on path, not configuring it..."))

        (unless (executable-find "godef")
          (display-warning '(user-configuration) "Unable to find `godef' on path"))

        (unless (executable-find "gocode")
          (display-warning '(user-configuration) "Unable to find `gocode' on path"))
      ...
      (unless (executable-find "guru")
        (display-warning '(user-configuration) "Unable to find `guru' on path"))

      ;; go guru not compatible with modules

      ;; (use-package go-guru
      ;;   :if (exectuable-find "guru")
      ;;   :after go-mode
